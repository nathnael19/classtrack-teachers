  ...
  return (
    <div className="relative space-y-10 font-sans p-4 mb-20">
      ...
      <div className="fixed inset-0 overflow-hidden -z-20 pointer-events-none">
        ...
        <div className="absolute top-[20%] -right-[5%] w-[30%] h-[50%] bg-amber-500/5 rounded-full blur-[100px] animate-pulse transition-all duration-[time:3000ms]" />
                  ...
                  <div className="relative z-10 space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-8 pt-6 border-t border-white/10">
                      {[
                        ...
                        { label: "Resources", value: 156, icon: Layers }, // Placeholder
                      ].map((stat) => (
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 pt-4 border-t border-white/10">
                  {[
                    ...
                    { label: "Room Status", value: "Optimal", color: "text-emerald-500" },
            ...
            <div className="col-span-12 lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              {isRoomsLoading ? (
                ...
                <div className="col-span-full py-20 text-center">
                  ...
                  <p className="text-xs font-black uppercase tracking-[0.3em] opacity-40 italic">No classrooms registered.</p>
                </div>
              )}
            </div>
          </div>
