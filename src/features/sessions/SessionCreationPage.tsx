  ...
  if (isLoadingCourses || isLoadingRooms) {
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] gap-6">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground animate-pulse">Loading...</p>
      </div>
    );
  }
                ...
                <CardContent className="p-12 space-y-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-4">
                          <FormLabel className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 ml-1">Duration (Minutes)</FormLabel>
                          <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-4">
                          <FormLabel className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 ml-1">Location Radius (Meters)</FormLabel>
                          <FormControl>
                            <div className="relative group">
                          ...
                          <FormDescription className="text-[9px] font-bold text-slate-300 uppercase tracking-widest mt-3 ml-2">Distance allowed from classroom.</FormDescription>
                          <FormMessage className="text-[9px] font-black uppercase tracking-widest text-destructive" />
                        </FormItem>
                      )}
                    />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-4">
                          <FormLabel className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 ml-1">Session Notes</FormLabel>
                          <FormControl>
                            <div className="relative group">
                              <Input
        ...
        <div className="lg:col-span-4 space-y-10">
          ...
          <div className="glass-card p-10 rounded-[2.5rem] bg-indigo-900 text-white space-y-8 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative flex flex-col items-center gap-4 border-b border-white/10 pb-8">
              ...
              <h3 className="text-[10px] font-black uppercase tracking-[0.4em] opacity-60">Recent Sessions</h3>
            </div>
            ...
            <div className="relative space-y-8">
              <div className="flex justify-between items-center bg-white/5 p-6 rounded-[1.5rem] border border-white/10 group hover:bg-white/10 transition-colors">
                <div className="flex flex-col gap-1">
                  <span className="text-[9px] font-black text-primary uppercase tracking-widest">Last Course</span>
